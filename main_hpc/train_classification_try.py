...
from utils import FaceDataSetAdjustment as FaceDataSet
...
if __name__ == "__main__":  
    ...
    for epoch in range(5):
        ...
        pd.DataFrame({'epoch': epoch_set, 
                      'metric': valid_set}).to_csv(f'data/adjustment/metrics/metric_{seed_}.csv', 
                                                   index=False)
        ...
        torch.save(model.module.state_dict(),
                   f'data/adjustment/models/model_simple_{seed_}.pt')
